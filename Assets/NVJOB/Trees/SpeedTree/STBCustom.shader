...
// #NVJOB shader for SpeedTree (STC). MIT license - license_nvjob.txt
// #NVJOB shader for SpeedTree V2.0 (STC) - https://github.com/nvjob/NVGen-Shader-for-Unity-SpeedTree
